module.exports = ({
  ...
  Example - $getServerVar[prefix]}{$color[$getServerVar[color]]}]
  $onlyPerms[manageserver;{description:❌ You require these permissions - **Manage Server** }{$color[$getServerVar[color]]}
